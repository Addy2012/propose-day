...
function drawText() {
  ...
  if (frameNumber > 1800 && frameNumber < 2100) {
    context.fillStyle = `rgba(255, 255, 255, ${opacity})`;
    context.fillText(
      "is so awesome and powerful in this entire universe",
      canvas.width / 2,
      canvas.height / 2
    );
    opacity = opacity + 0.01;
  ...
  if (frameNumber > 3000 && frameNumber < 99999) {
    ...
    if (window.innerWidth < 600) {
      drawTextWithLineBreaks(
        [
          "I started feeling you as my comfort place",
        ],
        canvas.width / 2,
        canvas.height / 2,
        fontSize,
  ...
  if (frameNumber >= 3300 && frameNumber < 99999) {
    ...
    if (window.innerWidth < 600) {
      drawTextWithLineBreaks(
        [
          "would you mind living happily ever",
          "after with me?",
        ],
        canvas.width / 2,
        canvas.height / 2 + 70,
      ...
      context.fillText(
        "would you mind living happily ever after with me?",
        canvas.width / 2,
        canvas.height / 2 + 50
      );
    }
  ...
  if (frameNumber >= 3600 && frameNumber < 99999) {
    ...
    context.fillText(
      "Let's promise together by clicking the button",
      canvas.width / 2,
      canvas.height / 2 + 120
    );
